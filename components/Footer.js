        ...
        <Col>
          <div className="cartolina-contatti-container">
            ...
            <ul className="cartolina-contatti-box">
              <li>
                {" "}
                <a href="https://www.facebook.com/search/top?q=himerazione">
                  <FaFacebookSquare /> Facebook
                </a>
              </li>
              <li>
                {" "}
                <a href="https://www.instagram.com/himerazione/">
              ...
              <li>
                {" "}
                <a href="/contact">
                  <FaMailBulk /> himerazione@gmail.com
                </a>
              </li>
              <li>
                {" "}
                <a href="https://www.youtube.com/channel/UCITrHB3DDf_JThPgSI3A1-A">
                  <FaYoutube /> YouTube{" "}
                </a>
              </li>
            </ul>
